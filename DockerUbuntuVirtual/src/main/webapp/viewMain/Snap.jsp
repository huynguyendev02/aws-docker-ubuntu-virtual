                    ...
                    <div style="width: 60%">
                        <div class="dropdown" style="width: 100%" align="right">
                            <a id="Launch" class="btn btn-primary"
                               href="${pageContext.request.contextPath}/Main/Snapshot/LaunchInstanceFromSnapshot"
                               role="button" style="width: 150px;visibility: hidden">Launch Instance</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <table style="width: 100%">
                        ...
                        <c:forEach items="${Snapshots}" var="c">
                            <tr align="center">
                                <td><input name="chooseInstance" type="radio" onclick="choose(${c.id})" value="Yes"/>
                                </td>
                                <td>${c.id}</td>
